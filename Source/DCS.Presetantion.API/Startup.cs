...
using DCS.Infra.CrossCutting.IoC.Containeres;
using DCS.Presetantion.API.Helpers;
using DCS.Presetantion.API.Security;
...
namespace DCS.Presetantion.API
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            ConfigureOAuth(app, container.Resolve<IUsuarioApp>());
        ...
        public void ConfigureOAuth(IAppBuilder app, IUsuarioApp usuarioApp)
        {
